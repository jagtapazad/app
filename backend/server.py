...
async def startup_db():
    ...
    if count == 0:
        default_agents = [
            ...
            {"id": "appoloi", "name": "Appoloi", "categories": ["People"], "api_url": None, "api_key_env": None, "is_opensource": False, "cost_per_query": 0.04, "description": "Advanced people research platform for professional background checks and analysis", "icon_url": None}
        ]
